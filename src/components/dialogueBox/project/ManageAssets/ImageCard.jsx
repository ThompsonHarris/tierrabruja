...
import { deleteProjectImage } from '../../../../redux/admin/admin.actions.js';
      ...
      <div className='bg-white border shadow-lg p-2 flex flex-row justify-start'>
        ...
        <div className='w-full self-center flex flex-col justify-start'>
          <div
            ...
            onClick={() => {
              this.props.deleteProjectImage(this.props.image);
            }}
          >
            delete
          </div>
...
const mapDispatchToProps = (dispatch) => ({
  deleteProjectImage: (image) => dispatch(deleteProjectImage(image)),
});
