...
import { deleteSettingImage } from '../../../../redux/general/general.actions';
      ...
      <div className='bg-white border shadow-lg p-2 flex flex-row justify-start'>
        ...
        <div className='w-full self-center flex flex-col justify-start'>
          <div
            ...
            onClick={() => {
              this.props.deleteSettingImage(this.props.image);
            }}
          >
            delete
          </div>
...
const mapDispatchToProps = (dispatch) => ({
  deleteSettingImage: (image) => dispatch(deleteSettingImage(image)),
});
